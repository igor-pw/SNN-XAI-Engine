...
public abstract class HiddenActivationFuncTest
{
    ...
    public void shouldUpdateToX_whenActivateIsUsed(String description, float input, float expected) {
        //given

        //when
        float result = getActivation().activate(input);
    ...
    public void shouldUpdateToVectorX_whenActivateIsUsed(String description, float [] input, float [] expected) {
        //given
